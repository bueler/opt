...
% and scalar d, so that discrete problem is unconstrained optimization
% over u in R^n:
%   min  fhat(u) = (1/2) u' Q u - c' u + d
% Generates a plot.  (The answer is boring and, incidentally, exact.)
