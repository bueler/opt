...
\begin{document}
\scriptsize \noindent Math 661 Optimization \hfill  Bueler; 11 December 2024
\normalsize\bigskip
...
\noindent (\emph{5 pts}) \textbf{Length, and staying on topic}  
\vspace{0.6in}

\noindent (\emph{10 pts}) \textbf{Correctness}
\vspace{0.6in}

\noindent (\emph{5 pts}) \textbf{Completeness}
\vspace{0.6in}

\noindent (\emph{5 pts}) \textbf{Readability and clarity}
\vspace{0.6in}
